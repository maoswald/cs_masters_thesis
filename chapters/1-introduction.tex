...
Hence, concepts, as for example authentication, are required to ensure the information security goals \cite{Wikipedia2017InformationSecurity}.
...
To prove the possibility of large \mxpufs and to study the impacts of \ac{MV} on the attacks in an empirical manner, simulations of the \pufs and the attacks are build and described in Chap. \ref{cap:simulationdesign}. %+
