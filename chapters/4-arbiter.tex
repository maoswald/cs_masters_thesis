...
It combines multiple individual \apufs with an \acf{XOR} function to a \xpuf, as shown in Figure \ref{fig:xorarbiter}.
...
Fig. \ref{fig:nandarbiter} displays the switching circuit build with two cross-coupled \ac{CMOS} NAND gates for an arbiter \cite{Mano2008Logicfundamentals}.
