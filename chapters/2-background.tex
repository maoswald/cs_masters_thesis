...
However, both definitions claim that the \ac{ML} algorithm learns, which is main purpose of the \ac{ML} algorithm.
...
Further, neither Samuel nor Mitchell define how the learned knowledge is stored.
...
The modifications are based on given examples that provide the experience E. 
