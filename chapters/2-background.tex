...
Controlled \pufs will not be considered further, as strong \pufs provide free access to the \ac{CRP} interface, compared with controlled \pufs. %+
% apufs are weak pufs:
...
As this thesis verifies the success of \acf{ML} attacks, this section provides some definitions for \ac{ML} algorithms and gives a introduction for the interaction with \pufs.
