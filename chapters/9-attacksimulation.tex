...
In this case a lowered reliability is already reached if a challenge $\gls{c}$ evaluates one or multiple times different to the rest of the evaluations for $\gls{j}$ evaluations and is called unreliable. % in contrast to term unstable.
...
\todo{update values + simu xpuf k=3}
\begin{figure}[ht]
