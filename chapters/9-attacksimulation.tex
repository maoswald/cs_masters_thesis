...
As pointed out in Sec. \ref{sec:essentialattacks} on the \ac{CMA-ES} attack is essential to large \xpufs.
...
For the reliability based \ac{CMA-ES} attack on \apufs it is crucial to find challenges which evaluate differently at multiple evaluations as explained in Sec. \ref{sec:machinelearningdesign}.
...
Do not get confused with the notions stability and reliability as the definition of reliability differs for the \ac{CMA-ES} attack, as explained in Sec. \ref{sec:machinelearningdesign}.
